...
Dados canônicos e inventários auditáveis de `gyarados`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0130-gyarados--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
