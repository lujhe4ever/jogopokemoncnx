...
Dados canônicos e inventários auditáveis de `exploud`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0295-exploud--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
