...
Dados canônicos e inventários auditáveis de `oricorio`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0741-oricorio--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
