...
Dados canônicos e inventários auditáveis de `scrafty`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0560-scrafty--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
