...
Dados canônicos e inventários auditáveis de `shuppet`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0353-shuppet--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
