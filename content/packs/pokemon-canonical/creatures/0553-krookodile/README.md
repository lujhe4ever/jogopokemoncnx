...
Dados canônicos e inventários auditáveis de `krookodile`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0553-krookodile--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
