...
Dados canônicos e inventários auditáveis de `pineco`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0204-pineco--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
