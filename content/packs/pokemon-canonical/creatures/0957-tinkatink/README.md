...
Dados canônicos e inventários auditáveis de `tinkatink`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0957-tinkatink--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
