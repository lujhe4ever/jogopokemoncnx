...
Dados canônicos e inventários auditáveis de `ceruledge`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0937-ceruledge--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
