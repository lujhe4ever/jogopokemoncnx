...
Dados canônicos e inventários auditáveis de `palafin`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0964-palafin--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
