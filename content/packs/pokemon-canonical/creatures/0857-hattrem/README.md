...
Dados canônicos e inventários auditáveis de `hattrem`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0857-hattrem--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
