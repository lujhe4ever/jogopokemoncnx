...
Dados canônicos e inventários auditáveis de `clauncher`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0692-clauncher--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
