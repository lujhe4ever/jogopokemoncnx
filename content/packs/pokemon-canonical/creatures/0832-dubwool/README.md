...
Dados canônicos e inventários auditáveis de `dubwool`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0832-dubwool--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
