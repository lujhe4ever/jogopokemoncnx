...
Dados canônicos e inventários auditáveis de `hatenna`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0856-hatenna--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
