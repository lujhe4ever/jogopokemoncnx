...
Dados canônicos e inventários auditáveis de `glastrier`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0896-glastrier--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
