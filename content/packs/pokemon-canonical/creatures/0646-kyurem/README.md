...
Dados canônicos e inventários auditáveis de `kyurem`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0646-kyurem--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
