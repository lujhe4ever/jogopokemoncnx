...
Dados canônicos e inventários auditáveis de `anorith`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0347-anorith--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
