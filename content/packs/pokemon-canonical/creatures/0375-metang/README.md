...
Dados canônicos e inventários auditáveis de `metang`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0375-metang--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
