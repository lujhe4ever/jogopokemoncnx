...
Dados canônicos e inventários auditáveis de `haxorus`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0612-haxorus--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
