...
Dados canônicos e inventários auditáveis de `toedscool`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0948-toedscool--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
