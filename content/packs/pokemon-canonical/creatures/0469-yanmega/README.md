...
Dados canônicos e inventários auditáveis de `yanmega`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0469-yanmega--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
