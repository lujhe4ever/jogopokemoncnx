...
Dados canônicos e inventários auditáveis de `sandile`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0551-sandile--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
