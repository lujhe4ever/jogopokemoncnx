...
Dados canônicos e inventários auditáveis de `iron-bundle`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0991-iron-bundle--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
