...
Dados canônicos e inventários auditáveis de `arrokuda`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0846-arrokuda--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
