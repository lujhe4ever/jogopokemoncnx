...
Dados canônicos e inventários auditáveis de `barbaracle`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0689-barbaracle--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
