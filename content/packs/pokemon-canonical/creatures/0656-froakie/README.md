...
Dados canônicos e inventários auditáveis de `froakie`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0656-froakie--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
