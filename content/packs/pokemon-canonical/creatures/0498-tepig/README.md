...
Dados canônicos e inventários auditáveis de `tepig`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0498-tepig--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
