...
Dados canônicos e inventários auditáveis de `blacephalon`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0806-blacephalon--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
