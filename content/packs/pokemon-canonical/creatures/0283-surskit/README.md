...
Dados canônicos e inventários auditáveis de `surskit`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0283-surskit--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
