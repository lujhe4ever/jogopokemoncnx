...
Dados canônicos e inventários auditáveis de `lurantis`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0754-lurantis--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
