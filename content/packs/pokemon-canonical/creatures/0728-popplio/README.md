...
Dados canônicos e inventários auditáveis de `popplio`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0728-popplio--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
