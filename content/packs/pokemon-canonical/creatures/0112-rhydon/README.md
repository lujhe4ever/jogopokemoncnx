...
Dados canônicos e inventários auditáveis de `rhydon`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0112-rhydon--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
