...
Dados canônicos e inventários auditáveis de `dachsbun`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0927-dachsbun--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
