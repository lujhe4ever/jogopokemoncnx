...
Dados canônicos e inventários auditáveis de `sirfetchd`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0865-sirfetchd--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
