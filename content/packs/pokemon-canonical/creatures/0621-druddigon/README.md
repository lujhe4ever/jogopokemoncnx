...
Dados canônicos e inventários auditáveis de `druddigon`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0621-druddigon--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
