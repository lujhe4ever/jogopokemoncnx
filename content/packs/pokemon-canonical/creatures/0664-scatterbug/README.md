...
Dados canônicos e inventários auditáveis de `scatterbug`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0664-scatterbug--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
