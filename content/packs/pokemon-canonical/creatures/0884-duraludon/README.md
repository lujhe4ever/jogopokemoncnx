...
Dados canônicos e inventários auditáveis de `duraludon`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0884-duraludon--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
