...
Dados canônicos e inventários auditáveis de `gligar`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0207-gligar--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
