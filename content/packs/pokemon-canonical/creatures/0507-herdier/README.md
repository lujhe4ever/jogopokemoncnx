...
Dados canônicos e inventários auditáveis de `herdier`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0507-herdier--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
