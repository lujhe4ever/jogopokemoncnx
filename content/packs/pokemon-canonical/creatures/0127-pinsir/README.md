...
Dados canônicos e inventários auditáveis de `pinsir`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0127-pinsir--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
