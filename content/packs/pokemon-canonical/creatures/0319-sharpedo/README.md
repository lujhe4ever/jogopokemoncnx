...
Dados canônicos e inventários auditáveis de `sharpedo`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0319-sharpedo--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
