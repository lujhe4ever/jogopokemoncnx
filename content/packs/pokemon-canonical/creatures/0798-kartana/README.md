...
Dados canônicos e inventários auditáveis de `kartana`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0798-kartana--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
