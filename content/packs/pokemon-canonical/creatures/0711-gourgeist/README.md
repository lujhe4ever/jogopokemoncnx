...
Dados canônicos e inventários auditáveis de `gourgeist`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0711-gourgeist--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
