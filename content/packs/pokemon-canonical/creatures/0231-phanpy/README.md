...
Dados canônicos e inventários auditáveis de `phanpy`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0231-phanpy--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
