...
Dados canônicos e inventários auditáveis de `snover`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0459-snover--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
