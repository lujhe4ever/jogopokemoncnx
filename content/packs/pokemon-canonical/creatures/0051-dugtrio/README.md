...
Dados canônicos e inventários auditáveis de `dugtrio`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0051-dugtrio--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
