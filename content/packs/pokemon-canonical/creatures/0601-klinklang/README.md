...
Dados canônicos e inventários auditáveis de `klinklang`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0601-klinklang--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
