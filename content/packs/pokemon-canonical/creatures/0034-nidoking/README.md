...
Dados canônicos e inventários auditáveis de `nidoking`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0034-nidoking--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
