...
Dados canônicos e inventários auditáveis de `deerling`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0585-deerling--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
