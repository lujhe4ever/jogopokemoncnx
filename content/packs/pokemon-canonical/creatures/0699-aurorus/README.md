...
Dados canônicos e inventários auditáveis de `aurorus`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0699-aurorus--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
