...
Dados canônicos e inventários auditáveis de `rowlet`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0722-rowlet--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
