...
Dados canônicos e inventários auditáveis de `hakamo-o`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0783-hakamo-o--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
