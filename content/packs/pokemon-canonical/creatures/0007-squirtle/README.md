...
Dados canônicos e inventários auditáveis de `squirtle`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0007-squirtle--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
