...
Dados canônicos e inventários auditáveis de `helioptile`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0694-helioptile--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
