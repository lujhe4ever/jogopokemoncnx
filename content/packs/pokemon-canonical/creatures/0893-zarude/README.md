...
Dados canônicos e inventários auditáveis de `zarude`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0893-zarude--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
