...
Dados canônicos e inventários auditáveis de `salamence`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0373-salamence--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
