...
Dados canônicos e inventários auditáveis de `chesnaught`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0652-chesnaught--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
