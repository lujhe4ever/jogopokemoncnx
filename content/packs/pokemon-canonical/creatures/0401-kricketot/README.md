...
Dados canônicos e inventários auditáveis de `kricketot`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0401-kricketot--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
