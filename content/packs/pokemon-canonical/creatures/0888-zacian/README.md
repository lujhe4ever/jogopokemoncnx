...
Dados canônicos e inventários auditáveis de `zacian`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0888-zacian--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
