...
Dados canônicos e inventários auditáveis de `budew`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0406-budew--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
