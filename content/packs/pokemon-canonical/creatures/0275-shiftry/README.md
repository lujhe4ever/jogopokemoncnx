...
Dados canônicos e inventários auditáveis de `shiftry`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0275-shiftry--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
