...
Dados canônicos e inventários auditáveis de `rampardos`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0409-rampardos--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
