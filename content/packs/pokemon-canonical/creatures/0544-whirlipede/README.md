...
Dados canônicos e inventários auditáveis de `whirlipede`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0544-whirlipede--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
