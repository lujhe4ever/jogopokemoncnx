...
Dados canônicos e inventários auditáveis de `glalie`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0362-glalie--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
