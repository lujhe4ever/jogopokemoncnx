...
Dados canônicos e inventários auditáveis de `fearow`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0022-fearow--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
