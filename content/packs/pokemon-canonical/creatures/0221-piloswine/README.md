...
Dados canônicos e inventários auditáveis de `piloswine`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0221-piloswine--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
