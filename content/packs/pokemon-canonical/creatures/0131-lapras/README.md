...
Dados canônicos e inventários auditáveis de `lapras`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0131-lapras--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
