...
Dados canônicos e inventários auditáveis de `drapion`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0452-drapion--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
