...
Dados canônicos e inventários auditáveis de `sceptile`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0254-sceptile--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
