...
Dados canônicos e inventários auditáveis de `fomantis`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0753-fomantis--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
