...
Dados canônicos e inventários auditáveis de `kubfu`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0891-kubfu--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
