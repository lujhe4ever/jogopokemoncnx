...
Dados canônicos e inventários auditáveis de `carnivine`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0455-carnivine--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
