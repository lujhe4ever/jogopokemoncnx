...
Dados canônicos e inventários auditáveis de `greavard`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0971-greavard--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
