...
Dados canônicos e inventários auditáveis de `serperior`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0497-serperior--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
