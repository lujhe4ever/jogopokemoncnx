...
Dados canônicos e inventários auditáveis de `grapploct`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0853-grapploct--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
