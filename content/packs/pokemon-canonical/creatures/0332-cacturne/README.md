...
Dados canônicos e inventários auditáveis de `cacturne`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0332-cacturne--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
