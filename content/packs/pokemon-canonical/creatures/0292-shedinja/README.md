...
Dados canônicos e inventários auditáveis de `shedinja`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0292-shedinja--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
