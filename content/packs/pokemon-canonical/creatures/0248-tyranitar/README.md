...
Dados canônicos e inventários auditáveis de `tyranitar`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0248-tyranitar--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
