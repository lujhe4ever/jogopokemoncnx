...
Dados canônicos e inventários auditáveis de `linoone`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0264-linoone--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
