...
Dados canônicos e inventários auditáveis de `kilowattrel`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0941-kilowattrel--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
