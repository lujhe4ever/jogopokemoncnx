...
Dados canônicos e inventários auditáveis de `piplup`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0393-piplup--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
