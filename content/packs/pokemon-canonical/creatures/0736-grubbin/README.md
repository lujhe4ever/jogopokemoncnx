...
Dados canônicos e inventários auditáveis de `grubbin`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0736-grubbin--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
