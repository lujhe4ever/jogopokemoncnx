...
Dados canônicos e inventários auditáveis de `wormadam`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0413-wormadam--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
