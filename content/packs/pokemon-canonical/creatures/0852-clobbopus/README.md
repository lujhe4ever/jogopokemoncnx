...
Dados canônicos e inventários auditáveis de `clobbopus`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0852-clobbopus--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
