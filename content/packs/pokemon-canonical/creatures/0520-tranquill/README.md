...
Dados canônicos e inventários auditáveis de `tranquill`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0520-tranquill--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
