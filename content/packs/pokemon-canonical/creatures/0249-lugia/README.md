...
Dados canônicos e inventários auditáveis de `lugia`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0249-lugia--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
