...
Dados canônicos e inventários auditáveis de `inkay`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0686-inkay--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
