...
Dados canônicos e inventários auditáveis de `shellder`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0090-shellder--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
