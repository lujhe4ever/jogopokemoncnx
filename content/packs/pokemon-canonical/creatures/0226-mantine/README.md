...
Dados canônicos e inventários auditáveis de `mantine`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0226-mantine--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
