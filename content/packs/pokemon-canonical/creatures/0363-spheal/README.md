...
Dados canônicos e inventários auditáveis de `spheal`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0363-spheal--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
