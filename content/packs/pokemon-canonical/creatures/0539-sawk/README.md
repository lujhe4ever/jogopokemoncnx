...
Dados canônicos e inventários auditáveis de `sawk`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0539-sawk--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
