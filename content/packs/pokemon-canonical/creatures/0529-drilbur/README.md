...
Dados canônicos e inventários auditáveis de `drilbur`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0529-drilbur--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
