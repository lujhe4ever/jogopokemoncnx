...
Dados canônicos e inventários auditáveis de `chewtle`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0833-chewtle--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
