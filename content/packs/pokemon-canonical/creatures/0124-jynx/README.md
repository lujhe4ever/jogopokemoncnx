...
Dados canônicos e inventários auditáveis de `jynx`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0124-jynx--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
