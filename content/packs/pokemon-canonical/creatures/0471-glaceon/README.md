...
Dados canônicos e inventários auditáveis de `glaceon`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0471-glaceon--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
