...
Dados canônicos e inventários auditáveis de `samurott`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0503-samurott--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
