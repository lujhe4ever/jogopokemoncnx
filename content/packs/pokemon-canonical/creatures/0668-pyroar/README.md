...
Dados canônicos e inventários auditáveis de `pyroar`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0668-pyroar--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
