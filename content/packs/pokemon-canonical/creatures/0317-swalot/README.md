...
Dados canônicos e inventários auditáveis de `swalot`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0317-swalot--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
