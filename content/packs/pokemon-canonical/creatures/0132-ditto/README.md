...
Dados canônicos e inventários auditáveis de `ditto`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0132-ditto--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
