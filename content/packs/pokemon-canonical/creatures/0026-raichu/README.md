...
Dados canônicos e inventários auditáveis de `raichu`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0026-raichu--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
