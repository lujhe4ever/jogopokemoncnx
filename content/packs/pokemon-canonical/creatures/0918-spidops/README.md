...
Dados canônicos e inventários auditáveis de `spidops`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0918-spidops--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
