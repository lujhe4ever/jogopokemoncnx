...
Dados canônicos e inventários auditáveis de `nymble`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0919-nymble--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
