...
Dados canônicos e inventários auditáveis de `hydreigon`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0635-hydreigon--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
