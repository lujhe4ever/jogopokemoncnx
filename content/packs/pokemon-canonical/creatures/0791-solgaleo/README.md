...
Dados canônicos e inventários auditáveis de `solgaleo`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0791-solgaleo--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
