...
Dados canônicos e inventários auditáveis de `whismur`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0293-whismur--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
