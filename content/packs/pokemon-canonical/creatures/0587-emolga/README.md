...
Dados canônicos e inventários auditáveis de `emolga`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0587-emolga--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
