...
Dados canônicos e inventários auditáveis de `terrakion`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0639-terrakion--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
