...
Dados canônicos e inventários auditáveis de `finneon`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0456-finneon--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
