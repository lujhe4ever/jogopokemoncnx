...
Dados canônicos e inventários auditáveis de `stoutland`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0508-stoutland--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
