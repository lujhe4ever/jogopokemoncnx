...
Dados canônicos e inventários auditáveis de `carbink`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0703-carbink--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
