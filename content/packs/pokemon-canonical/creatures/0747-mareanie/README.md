...
Dados canônicos e inventários auditáveis de `mareanie`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0747-mareanie--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
