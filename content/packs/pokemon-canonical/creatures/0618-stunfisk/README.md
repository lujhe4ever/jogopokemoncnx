...
Dados canônicos e inventários auditáveis de `stunfisk`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0618-stunfisk--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
