...
Dados canônicos e inventários auditáveis de `servine`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0496-servine--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
