...
Dados canônicos e inventários auditáveis de `kricketune`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0402-kricketune--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
