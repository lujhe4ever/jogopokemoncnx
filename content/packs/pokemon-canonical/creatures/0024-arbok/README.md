...
Dados canônicos e inventários auditáveis de `arbok`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0024-arbok--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
