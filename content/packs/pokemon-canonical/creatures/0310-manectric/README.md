...
Dados canônicos e inventários auditáveis de `manectric`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0310-manectric--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
