...
Dados canônicos e inventários auditáveis de `stantler`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0234-stantler--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
