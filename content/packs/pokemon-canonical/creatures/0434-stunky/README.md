...
Dados canônicos e inventários auditáveis de `stunky`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0434-stunky--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
