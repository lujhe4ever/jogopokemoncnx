...
Dados canônicos e inventários auditáveis de `shinx`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0403-shinx--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
