...
Dados canônicos e inventários auditáveis de `trapinch`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0328-trapinch--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
