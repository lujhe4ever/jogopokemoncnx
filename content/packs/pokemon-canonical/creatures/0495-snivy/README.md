...
Dados canônicos e inventários auditáveis de `snivy`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0495-snivy--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
