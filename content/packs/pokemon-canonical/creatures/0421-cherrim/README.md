...
Dados canônicos e inventários auditáveis de `cherrim`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0421-cherrim--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
