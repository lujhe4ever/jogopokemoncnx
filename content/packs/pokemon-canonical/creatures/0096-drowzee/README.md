...
Dados canônicos e inventários auditáveis de `drowzee`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0096-drowzee--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
