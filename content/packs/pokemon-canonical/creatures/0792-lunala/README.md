...
Dados canônicos e inventários auditáveis de `lunala`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0792-lunala--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
