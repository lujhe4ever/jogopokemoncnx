...
Dados canônicos e inventários auditáveis de `brambleghast`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0947-brambleghast--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
