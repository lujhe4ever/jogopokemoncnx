...
Dados canônicos e inventários auditáveis de `charcadet`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0935-charcadet--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
