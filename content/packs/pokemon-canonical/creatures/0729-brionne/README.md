...
Dados canônicos e inventários auditáveis de `brionne`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0729-brionne--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
