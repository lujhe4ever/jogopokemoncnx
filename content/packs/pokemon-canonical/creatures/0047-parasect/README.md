...
Dados canônicos e inventários auditáveis de `parasect`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0047-parasect--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
