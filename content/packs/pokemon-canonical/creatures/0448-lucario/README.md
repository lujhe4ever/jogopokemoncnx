...
Dados canônicos e inventários auditáveis de `lucario`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0448-lucario--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
