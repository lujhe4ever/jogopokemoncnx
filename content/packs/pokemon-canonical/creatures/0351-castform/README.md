...
Dados canônicos e inventários auditáveis de `castform`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0351-castform--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
