...
Dados canônicos e inventários auditáveis de `ambipom`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0424-ambipom--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
