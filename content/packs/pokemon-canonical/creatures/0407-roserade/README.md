...
Dados canônicos e inventários auditáveis de `roserade`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0407-roserade--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
