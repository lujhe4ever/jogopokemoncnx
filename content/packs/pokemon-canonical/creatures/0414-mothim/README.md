...
Dados canônicos e inventários auditáveis de `mothim`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0414-mothim--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
