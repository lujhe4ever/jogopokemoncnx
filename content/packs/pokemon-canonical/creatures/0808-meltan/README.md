...
Dados canônicos e inventários auditáveis de `meltan`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0808-meltan--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
