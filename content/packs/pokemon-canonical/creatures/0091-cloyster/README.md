...
Dados canônicos e inventários auditáveis de `cloyster`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0091-cloyster--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
