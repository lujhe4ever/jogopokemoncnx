...
Dados canônicos e inventários auditáveis de `infernape`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0392-infernape--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
