...
Dados canônicos e inventários auditáveis de `rolycoly`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0837-rolycoly--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
