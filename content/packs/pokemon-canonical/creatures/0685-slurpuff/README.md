...
Dados canônicos e inventários auditáveis de `slurpuff`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0685-slurpuff--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
