...
Dados canônicos e inventários auditáveis de `houndour`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0228-houndour--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
