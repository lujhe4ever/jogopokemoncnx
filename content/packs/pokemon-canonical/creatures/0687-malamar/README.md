...
Dados canônicos e inventários auditáveis de `malamar`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0687-malamar--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
