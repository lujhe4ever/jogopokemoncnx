...
Dados canônicos e inventários auditáveis de `vanillish`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0583-vanillish--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
