...
Dados canônicos e inventários auditáveis de `duosion`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0578-duosion--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
