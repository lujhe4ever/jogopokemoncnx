...
Dados canônicos e inventários auditáveis de `marshadow`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0802-marshadow--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
