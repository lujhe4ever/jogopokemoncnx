...
Dados canônicos e inventários auditáveis de `beartic`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0614-beartic--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
