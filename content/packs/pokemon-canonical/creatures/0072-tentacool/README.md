...
Dados canônicos e inventários auditáveis de `tentacool`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0072-tentacool--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
