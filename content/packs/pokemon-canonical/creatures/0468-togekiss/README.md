...
Dados canônicos e inventários auditáveis de `togekiss`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0468-togekiss--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
