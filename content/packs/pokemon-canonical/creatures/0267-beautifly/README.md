...
Dados canônicos e inventários auditáveis de `beautifly`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0267-beautifly--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
