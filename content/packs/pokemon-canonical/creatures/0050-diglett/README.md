...
Dados canônicos e inventários auditáveis de `diglett`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0050-diglett--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
