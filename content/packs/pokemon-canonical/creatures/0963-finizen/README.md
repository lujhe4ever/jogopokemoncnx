...
Dados canônicos e inventários auditáveis de `finizen`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0963-finizen--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
