...
Dados canônicos e inventários auditáveis de `tapu-lele`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0786-tapu-lele--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
