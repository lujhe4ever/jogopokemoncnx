...
Dados canônicos e inventários auditáveis de `espurr`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0677-espurr--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
