...
Dados canônicos e inventários auditáveis de `zangoose`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0335-zangoose--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
