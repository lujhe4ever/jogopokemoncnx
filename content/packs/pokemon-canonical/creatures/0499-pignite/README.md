...
Dados canônicos e inventários auditáveis de `pignite`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0499-pignite--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
