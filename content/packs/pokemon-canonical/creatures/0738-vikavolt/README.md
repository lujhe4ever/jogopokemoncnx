...
Dados canônicos e inventários auditáveis de `vikavolt`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0738-vikavolt--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
