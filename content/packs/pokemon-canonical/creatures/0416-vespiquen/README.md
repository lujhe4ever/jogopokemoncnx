...
Dados canônicos e inventários auditáveis de `vespiquen`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0416-vespiquen--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
