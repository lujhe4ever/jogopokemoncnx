...
Dados canônicos e inventários auditáveis de `yanma`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0193-yanma--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
