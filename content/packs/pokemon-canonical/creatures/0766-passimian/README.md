...
Dados canônicos e inventários auditáveis de `passimian`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0766-passimian--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
