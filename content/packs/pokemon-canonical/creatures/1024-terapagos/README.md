...
Dados canônicos e inventários auditáveis de `terapagos`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `1024-terapagos--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
