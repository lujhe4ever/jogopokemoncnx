...
Dados canônicos e inventários auditáveis de `coalossal`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0839-coalossal--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
