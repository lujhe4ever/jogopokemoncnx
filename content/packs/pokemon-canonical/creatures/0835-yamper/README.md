...
Dados canônicos e inventários auditáveis de `yamper`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0835-yamper--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
