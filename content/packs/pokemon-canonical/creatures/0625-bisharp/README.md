...
Dados canônicos e inventários auditáveis de `bisharp`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0625-bisharp--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
