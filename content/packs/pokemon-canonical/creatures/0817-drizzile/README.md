...
Dados canônicos e inventários auditáveis de `drizzile`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0817-drizzile--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
