...
Dados canônicos e inventários auditáveis de `bewear`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0760-bewear--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
