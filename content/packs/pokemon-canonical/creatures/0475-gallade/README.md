...
Dados canônicos e inventários auditáveis de `gallade`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0475-gallade--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
