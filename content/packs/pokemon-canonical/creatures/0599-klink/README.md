...
Dados canônicos e inventários auditáveis de `klink`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0599-klink--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
