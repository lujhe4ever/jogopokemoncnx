...
Dados canônicos e inventários auditáveis de `dusknoir`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0477-dusknoir--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
