...
Dados canônicos e inventários auditáveis de `nincada`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0290-nincada--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
