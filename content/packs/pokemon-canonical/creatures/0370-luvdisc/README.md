...
Dados canônicos e inventários auditáveis de `luvdisc`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0370-luvdisc--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
