...
Dados canônicos e inventários auditáveis de `tapu-koko`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0785-tapu-koko--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
