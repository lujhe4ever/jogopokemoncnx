...
Dados canônicos e inventários auditáveis de `chandelure`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0609-chandelure--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
