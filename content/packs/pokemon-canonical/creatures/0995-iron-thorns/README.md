...
Dados canônicos e inventários auditáveis de `iron-thorns`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0995-iron-thorns--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
