...
Dados canônicos e inventários auditáveis de `tarountula`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0917-tarountula--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
