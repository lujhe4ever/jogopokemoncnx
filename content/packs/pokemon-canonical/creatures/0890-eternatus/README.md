...
Dados canônicos e inventários auditáveis de `eternatus`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0890-eternatus--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
