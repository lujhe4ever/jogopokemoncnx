...
Dados canônicos e inventários auditáveis de `talonflame`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0663-talonflame--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
