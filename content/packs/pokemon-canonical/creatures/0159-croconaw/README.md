...
Dados canônicos e inventários auditáveis de `croconaw`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0159-croconaw--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
