...
Dados canônicos e inventários auditáveis de `palossand`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0770-palossand--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
