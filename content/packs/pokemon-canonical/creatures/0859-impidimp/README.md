...
Dados canônicos e inventários auditáveis de `impidimp`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0859-impidimp--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
