...
Dados canônicos e inventários auditáveis de `bramblin`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0946-bramblin--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
