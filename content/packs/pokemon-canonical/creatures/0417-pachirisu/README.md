...
Dados canônicos e inventários auditáveis de `pachirisu`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0417-pachirisu--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
