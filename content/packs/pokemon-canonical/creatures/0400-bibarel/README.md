...
Dados canônicos e inventários auditáveis de `bibarel`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0400-bibarel--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
