...
Dados canônicos e inventários auditáveis de `applin`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0840-applin--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
