...
Dados canônicos e inventários auditáveis de `sobble`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0816-sobble--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
