...
Dados canônicos e inventários auditáveis de `minccino`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0572-minccino--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
