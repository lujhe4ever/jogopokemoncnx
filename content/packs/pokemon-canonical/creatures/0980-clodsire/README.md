...
Dados canônicos e inventários auditáveis de `clodsire`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0980-clodsire--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
