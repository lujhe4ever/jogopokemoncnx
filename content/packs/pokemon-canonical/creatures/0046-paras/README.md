...
Dados canônicos e inventários auditáveis de `paras`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0046-paras--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
