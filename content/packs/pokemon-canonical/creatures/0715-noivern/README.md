...
Dados canônicos e inventários auditáveis de `noivern`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0715-noivern--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
