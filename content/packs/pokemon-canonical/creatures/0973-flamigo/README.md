...
Dados canônicos e inventários auditáveis de `flamigo`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0973-flamigo--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
