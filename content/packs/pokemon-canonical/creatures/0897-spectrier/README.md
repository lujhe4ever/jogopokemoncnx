...
Dados canônicos e inventários auditáveis de `spectrier`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0897-spectrier--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
