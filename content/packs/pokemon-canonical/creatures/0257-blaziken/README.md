...
Dados canônicos e inventários auditáveis de `blaziken`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0257-blaziken--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
