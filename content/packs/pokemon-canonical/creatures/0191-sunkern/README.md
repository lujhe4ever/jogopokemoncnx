...
Dados canônicos e inventários auditáveis de `sunkern`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0191-sunkern--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
