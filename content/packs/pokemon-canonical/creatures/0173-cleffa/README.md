...
Dados canônicos e inventários auditáveis de `cleffa`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0173-cleffa--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
