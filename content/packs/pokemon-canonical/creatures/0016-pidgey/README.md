...
Dados canônicos e inventários auditáveis de `pidgey`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0016-pidgey--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
