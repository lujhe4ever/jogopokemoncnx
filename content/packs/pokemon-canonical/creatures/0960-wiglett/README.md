...
Dados canônicos e inventários auditáveis de `wiglett`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0960-wiglett--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
