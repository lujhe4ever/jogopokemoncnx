...
Dados canônicos e inventários auditáveis de `illumise`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0314-illumise--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
