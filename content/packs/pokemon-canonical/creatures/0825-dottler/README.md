...
Dados canônicos e inventários auditáveis de `dottler`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0825-dottler--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
