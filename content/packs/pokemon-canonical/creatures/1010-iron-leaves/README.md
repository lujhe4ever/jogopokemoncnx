...
Dados canônicos e inventários auditáveis de `iron-leaves`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `1010-iron-leaves--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
