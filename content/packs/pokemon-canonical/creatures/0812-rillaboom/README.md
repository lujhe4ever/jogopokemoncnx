...
Dados canônicos e inventários auditáveis de `rillaboom`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0812-rillaboom--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
