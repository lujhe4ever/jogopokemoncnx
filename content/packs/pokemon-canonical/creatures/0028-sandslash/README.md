...
Dados canônicos e inventários auditáveis de `sandslash`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0028-sandslash--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
