...
Dados canônicos e inventários auditáveis de `durant`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0632-durant--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
