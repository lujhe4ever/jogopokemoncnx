...
Dados canônicos e inventários auditáveis de `spiritomb`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0442-spiritomb--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
