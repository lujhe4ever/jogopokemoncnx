...
Dados canônicos e inventários auditáveis de `sneasler`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0903-sneasler--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
