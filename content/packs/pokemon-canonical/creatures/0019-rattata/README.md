...
Dados canônicos e inventários auditáveis de `rattata`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0019-rattata--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
