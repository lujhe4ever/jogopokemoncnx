...
Dados canônicos e inventários auditáveis de `marshtomp`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0259-marshtomp--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
