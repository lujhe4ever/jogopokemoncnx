...
Dados canônicos e inventários auditáveis de `dwebble`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0557-dwebble--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
