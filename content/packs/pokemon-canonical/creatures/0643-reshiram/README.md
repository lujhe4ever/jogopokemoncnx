...
Dados canônicos e inventários auditáveis de `reshiram`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0643-reshiram--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
