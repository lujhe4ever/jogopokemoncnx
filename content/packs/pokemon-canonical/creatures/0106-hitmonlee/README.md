...
Dados canônicos e inventários auditáveis de `hitmonlee`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0106-hitmonlee--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
