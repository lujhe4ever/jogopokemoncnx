...
Dados canônicos e inventários auditáveis de `maushold`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0925-maushold--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
