...
Dados canônicos e inventários auditáveis de `dartrix`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0723-dartrix--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
