...
Dados canônicos e inventários auditáveis de `kingler`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0099-kingler--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
