...
Dados canônicos e inventários auditáveis de `greninja`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0658-greninja--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
