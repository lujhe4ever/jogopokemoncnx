...
Dados canônicos e inventários auditáveis de `zygarde`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0718-zygarde--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
