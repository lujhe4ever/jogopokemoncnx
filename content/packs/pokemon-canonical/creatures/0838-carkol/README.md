...
Dados canônicos e inventários auditáveis de `carkol`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0838-carkol--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
