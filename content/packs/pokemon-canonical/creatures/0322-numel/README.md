...
Dados canônicos e inventários auditáveis de `numel`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0322-numel--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
