...
Dados canônicos e inventários auditáveis de `xatu`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0178-xatu--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
