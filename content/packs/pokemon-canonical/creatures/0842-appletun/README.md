...
Dados canônicos e inventários auditáveis de `appletun`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0842-appletun--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
