...
Dados canônicos e inventários auditáveis de `heliolisk`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0695-heliolisk--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
