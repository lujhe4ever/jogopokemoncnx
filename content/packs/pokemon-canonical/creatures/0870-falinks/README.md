...
Dados canônicos e inventários auditáveis de `falinks`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0870-falinks--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
