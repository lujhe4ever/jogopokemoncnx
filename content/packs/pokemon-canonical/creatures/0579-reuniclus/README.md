...
Dados canônicos e inventários auditáveis de `reuniclus`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0579-reuniclus--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
