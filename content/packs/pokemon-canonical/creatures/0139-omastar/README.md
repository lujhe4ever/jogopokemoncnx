...
Dados canônicos e inventários auditáveis de `omastar`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0139-omastar--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
