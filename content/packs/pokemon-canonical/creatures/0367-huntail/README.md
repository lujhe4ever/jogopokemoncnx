...
Dados canônicos e inventários auditáveis de `huntail`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0367-huntail--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
