...
Dados canônicos e inventários auditáveis de `klefki`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0707-klefki--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
