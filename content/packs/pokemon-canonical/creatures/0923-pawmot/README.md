...
Dados canônicos e inventários auditáveis de `pawmot`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0923-pawmot--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
