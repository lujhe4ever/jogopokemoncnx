...
Dados canônicos e inventários auditáveis de `wigglytuff`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0040-wigglytuff--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
