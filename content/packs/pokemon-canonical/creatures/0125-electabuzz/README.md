...
Dados canônicos e inventários auditáveis de `electabuzz`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0125-electabuzz--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
