...
Dados canônicos e inventários auditáveis de `polteageist`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0855-polteageist--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
