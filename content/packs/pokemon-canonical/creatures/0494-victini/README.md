...
Dados canônicos e inventários auditáveis de `victini`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0494-victini--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
