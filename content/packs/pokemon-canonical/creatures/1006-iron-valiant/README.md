...
Dados canônicos e inventários auditáveis de `iron-valiant`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `1006-iron-valiant--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
