...
Dados canônicos e inventários auditáveis de `spritzee`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0682-spritzee--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
