...
Dados canônicos e inventários auditáveis de `elgyem`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0605-elgyem--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
