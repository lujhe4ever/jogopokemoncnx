...
Dados canônicos e inventários auditáveis de `rapidash`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0078-rapidash--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
