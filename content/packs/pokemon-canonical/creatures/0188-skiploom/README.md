...
Dados canônicos e inventários auditáveis de `skiploom`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0188-skiploom--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
