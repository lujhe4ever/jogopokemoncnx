...
Dados canônicos e inventários auditáveis de `eiscue`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0875-eiscue--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
