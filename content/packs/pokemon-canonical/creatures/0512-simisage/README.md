...
Dados canônicos e inventários auditáveis de `simisage`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0512-simisage--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
