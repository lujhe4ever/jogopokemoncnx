...
Dados canônicos e inventários auditáveis de `iron-treads`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0990-iron-treads--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
