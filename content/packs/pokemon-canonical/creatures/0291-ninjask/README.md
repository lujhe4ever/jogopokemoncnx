...
Dados canônicos e inventários auditáveis de `ninjask`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0291-ninjask--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
