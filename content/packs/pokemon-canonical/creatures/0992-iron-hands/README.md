...
Dados canônicos e inventários auditáveis de `iron-hands`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0992-iron-hands--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
