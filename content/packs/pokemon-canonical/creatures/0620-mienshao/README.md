...
Dados canônicos e inventários auditáveis de `mienshao`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0620-mienshao--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
