...
Dados canônicos e inventários auditáveis de `empoleon`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0395-empoleon--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
