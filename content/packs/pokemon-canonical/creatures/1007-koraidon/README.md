...
Dados canônicos e inventários auditáveis de `koraidon`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `1007-koraidon--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
