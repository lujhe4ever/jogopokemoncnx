...
Dados canônicos e inventários auditáveis de `drampa`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0780-drampa--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
