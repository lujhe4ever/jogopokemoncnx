...
Dados canônicos e inventários auditáveis de `butterfree`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0012-butterfree--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
