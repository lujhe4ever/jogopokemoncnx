...
Dados canônicos e inventários auditáveis de `zubat`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0041-zubat--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
