...
Dados canônicos e inventários auditáveis de `staravia`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0397-staravia--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
