...
Dados canônicos e inventários auditáveis de `melmetal`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0809-melmetal--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
