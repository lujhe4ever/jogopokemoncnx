...
Dados canônicos e inventários auditáveis de `heatran`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0485-heatran--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
