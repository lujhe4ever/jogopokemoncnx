...
Dados canônicos e inventários auditáveis de `swadloon`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0541-swadloon--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
