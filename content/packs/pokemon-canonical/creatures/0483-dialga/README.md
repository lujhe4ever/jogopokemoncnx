...
Dados canônicos e inventários auditáveis de `dialga`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0483-dialga--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
