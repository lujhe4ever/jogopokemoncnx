...
Dados canônicos e inventários auditáveis de `sandaconda`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0844-sandaconda--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
