...
Dados canônicos e inventários auditáveis de `donphan`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0232-donphan--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
