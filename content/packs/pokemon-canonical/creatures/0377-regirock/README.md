...
Dados canônicos e inventários auditáveis de `regirock`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0377-regirock--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
