...
Dados canônicos e inventários auditáveis de `deoxys`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0386-deoxys--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
