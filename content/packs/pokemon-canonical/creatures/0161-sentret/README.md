...
Dados canônicos e inventários auditáveis de `sentret`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0161-sentret--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
