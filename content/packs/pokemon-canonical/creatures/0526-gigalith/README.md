...
Dados canônicos e inventários auditáveis de `gigalith`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0526-gigalith--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
