...
Dados canônicos e inventários auditáveis de `regieleki`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0894-regieleki--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
