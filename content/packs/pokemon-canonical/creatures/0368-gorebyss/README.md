...
Dados canônicos e inventários auditáveis de `gorebyss`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0368-gorebyss--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
