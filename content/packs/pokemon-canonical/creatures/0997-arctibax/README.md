...
Dados canônicos e inventários auditáveis de `arctibax`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0997-arctibax--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
