...
Dados canônicos e inventários auditáveis de `nosepass`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0299-nosepass--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
