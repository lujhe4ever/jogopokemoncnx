...
Dados canônicos e inventários auditáveis de `cresselia`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0488-cresselia--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
