...
Dados canônicos e inventários auditáveis de `furfrou`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0676-furfrou--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
