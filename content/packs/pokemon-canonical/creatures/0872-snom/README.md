...
Dados canônicos e inventários auditáveis de `snom`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0872-snom--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
