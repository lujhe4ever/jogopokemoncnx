...
Dados canônicos e inventários auditáveis de `voltorb`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0100-voltorb--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
