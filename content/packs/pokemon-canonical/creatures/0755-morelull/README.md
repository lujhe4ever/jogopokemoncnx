...
Dados canônicos e inventários auditáveis de `morelull`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0755-morelull--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
