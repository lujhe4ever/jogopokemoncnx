...
Dados canônicos e inventários auditáveis de `toedscruel`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0949-toedscruel--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
