...
Dados canônicos e inventários auditáveis de `lycanroc`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0745-lycanroc--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
