...
Dados canônicos e inventários auditáveis de `cradily`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0346-cradily--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
