...
Dados canônicos e inventários auditáveis de `magikarp`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0129-magikarp--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
