...
Dados canônicos e inventários auditáveis de `wyrdeer`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0899-wyrdeer--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
