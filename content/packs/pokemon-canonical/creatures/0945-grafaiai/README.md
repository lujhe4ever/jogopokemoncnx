...
Dados canônicos e inventários auditáveis de `grafaiai`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0945-grafaiai--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
