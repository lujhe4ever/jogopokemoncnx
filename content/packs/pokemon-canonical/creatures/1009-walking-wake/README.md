...
Dados canônicos e inventários auditáveis de `walking-wake`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `1009-walking-wake--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
