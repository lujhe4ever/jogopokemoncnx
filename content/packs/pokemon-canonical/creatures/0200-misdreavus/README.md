...
Dados canônicos e inventários auditáveis de `misdreavus`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0200-misdreavus--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
