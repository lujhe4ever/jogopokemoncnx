...
Dados canônicos e inventários auditáveis de `vaporeon`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0134-vaporeon--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
