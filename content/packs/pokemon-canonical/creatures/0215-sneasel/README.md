...
Dados canônicos e inventários auditáveis de `sneasel`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0215-sneasel--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
