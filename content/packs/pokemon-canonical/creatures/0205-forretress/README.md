...
Dados canônicos e inventários auditáveis de `forretress`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0205-forretress--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
