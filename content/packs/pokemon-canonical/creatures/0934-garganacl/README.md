...
Dados canônicos e inventários auditáveis de `garganacl`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0934-garganacl--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
