...
Dados canônicos e inventários auditáveis de `metapod`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0011-metapod--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
