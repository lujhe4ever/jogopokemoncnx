...
Dados canônicos e inventários auditáveis de `watchog`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0505-watchog--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
