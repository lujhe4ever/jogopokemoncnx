...
Dados canônicos e inventários auditáveis de `clawitzer`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0693-clawitzer--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
