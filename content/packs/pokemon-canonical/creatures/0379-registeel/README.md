...
Dados canônicos e inventários auditáveis de `registeel`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0379-registeel--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
