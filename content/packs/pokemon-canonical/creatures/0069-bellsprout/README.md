...
Dados canônicos e inventários auditáveis de `bellsprout`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0069-bellsprout--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
