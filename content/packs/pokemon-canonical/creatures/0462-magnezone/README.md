...
Dados canônicos e inventários auditáveis de `magnezone`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0462-magnezone--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
