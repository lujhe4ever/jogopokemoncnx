...
Dados canônicos e inventários auditáveis de `remoraid`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0223-remoraid--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
