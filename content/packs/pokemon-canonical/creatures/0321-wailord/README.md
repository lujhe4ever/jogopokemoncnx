...
Dados canônicos e inventários auditáveis de `wailord`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0321-wailord--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
