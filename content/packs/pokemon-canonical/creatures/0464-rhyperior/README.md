...
Dados canônicos e inventários auditáveis de `rhyperior`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0464-rhyperior--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
