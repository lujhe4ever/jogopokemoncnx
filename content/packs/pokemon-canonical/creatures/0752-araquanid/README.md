...
Dados canônicos e inventários auditáveis de `araquanid`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0752-araquanid--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
