...
Dados canônicos e inventários auditáveis de `litwick`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0607-litwick--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
