...
Dados canônicos e inventários auditáveis de `iron-boulder`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `1022-iron-boulder--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
