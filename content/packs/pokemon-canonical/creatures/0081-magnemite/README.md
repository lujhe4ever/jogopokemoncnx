...
Dados canônicos e inventários auditáveis de `magnemite`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0081-magnemite--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
