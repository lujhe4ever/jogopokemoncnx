...
Dados canônicos e inventários auditáveis de `annihilape`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0979-annihilape--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
