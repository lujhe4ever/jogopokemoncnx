...
Dados canônicos e inventários auditáveis de `dreepy`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0885-dreepy--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
