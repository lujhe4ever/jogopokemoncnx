...
Dados canônicos e inventários auditáveis de `krabby`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0098-krabby--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
