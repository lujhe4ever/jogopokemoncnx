...
Dados canônicos e inventários auditáveis de `golbat`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0042-golbat--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
