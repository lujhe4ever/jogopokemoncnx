...
Dados canônicos e inventários auditáveis de `ninetales`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0038-ninetales--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
