...
Dados canônicos e inventários auditáveis de `wingull`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0278-wingull--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
