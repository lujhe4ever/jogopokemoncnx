...
Dados canônicos e inventários auditáveis de `weepinbell`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0070-weepinbell--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
