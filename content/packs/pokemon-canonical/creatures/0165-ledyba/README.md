...
Dados canônicos e inventários auditáveis de `ledyba`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0165-ledyba--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
