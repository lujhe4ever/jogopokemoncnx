...
Dados canônicos e inventários auditáveis de `smoochum`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0238-smoochum--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
