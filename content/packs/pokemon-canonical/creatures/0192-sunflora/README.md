...
Dados canônicos e inventários auditáveis de `sunflora`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0192-sunflora--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
