...
Dados canônicos e inventários auditáveis de `gible`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0443-gible--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
