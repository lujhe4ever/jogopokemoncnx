...
Dados canônicos e inventários auditáveis de `aegislash`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0681-aegislash--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
