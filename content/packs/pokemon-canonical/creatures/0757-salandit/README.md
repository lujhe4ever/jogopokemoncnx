...
Dados canônicos e inventários auditáveis de `salandit`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0757-salandit--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
