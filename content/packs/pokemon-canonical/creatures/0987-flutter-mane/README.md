...
Dados canônicos e inventários auditáveis de `flutter-mane`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0987-flutter-mane--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
