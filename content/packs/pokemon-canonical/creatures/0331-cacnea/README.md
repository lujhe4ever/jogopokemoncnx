...
Dados canônicos e inventários auditáveis de `cacnea`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0331-cacnea--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
