...
Dados canônicos e inventários auditáveis de `relicanth`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0369-relicanth--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
