...
Dados canônicos e inventários auditáveis de `yamask`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0562-yamask--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
