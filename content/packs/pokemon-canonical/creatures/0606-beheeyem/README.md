...
Dados canônicos e inventários auditáveis de `beheeyem`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0606-beheeyem--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
