...
Dados canônicos e inventários auditáveis de `skeledirge`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0911-skeledirge--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
