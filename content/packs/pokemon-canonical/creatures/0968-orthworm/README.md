...
Dados canônicos e inventários auditáveis de `orthworm`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0968-orthworm--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
