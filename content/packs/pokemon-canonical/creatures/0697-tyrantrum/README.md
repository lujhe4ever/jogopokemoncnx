...
Dados canônicos e inventários auditáveis de `tyrantrum`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0697-tyrantrum--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
