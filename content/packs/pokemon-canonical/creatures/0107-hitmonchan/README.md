...
Dados canônicos e inventários auditáveis de `hitmonchan`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0107-hitmonchan--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
