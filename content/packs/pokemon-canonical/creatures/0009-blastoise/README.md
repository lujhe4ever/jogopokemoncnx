...
Dados canônicos e inventários auditáveis de `blastoise`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0009-blastoise--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
