...
Dados canônicos e inventários auditáveis de `dipplin`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `1011-dipplin--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
