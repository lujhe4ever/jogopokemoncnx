...
Dados canônicos e inventários auditáveis de `tatsugiri`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0978-tatsugiri--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
