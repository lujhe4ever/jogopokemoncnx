...
Dados canônicos e inventários auditáveis de `naclstack`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0933-naclstack--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
