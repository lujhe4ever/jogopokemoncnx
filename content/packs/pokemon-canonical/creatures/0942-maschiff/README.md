...
Dados canônicos e inventários auditáveis de `maschiff`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0942-maschiff--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
