...
Dados canônicos e inventários auditáveis de `goodra`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0706-goodra--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
