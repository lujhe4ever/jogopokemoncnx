...
Dados canônicos e inventários auditáveis de `blitzle`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0522-blitzle--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
