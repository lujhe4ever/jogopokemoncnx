...
Dados canônicos e inventários auditáveis de `latios`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0381-latios--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
