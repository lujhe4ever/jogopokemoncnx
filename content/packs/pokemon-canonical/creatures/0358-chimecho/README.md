...
Dados canônicos e inventários auditáveis de `chimecho`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0358-chimecho--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
