...
Dados canônicos e inventários auditáveis de `electrode`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0101-electrode--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
