...
Dados canônicos e inventários auditáveis de `cyndaquil`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0155-cyndaquil--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
