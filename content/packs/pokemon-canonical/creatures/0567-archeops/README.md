...
Dados canônicos e inventários auditáveis de `archeops`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0567-archeops--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
