...
Dados canônicos e inventários auditáveis de `flaaffy`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0180-flaaffy--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
