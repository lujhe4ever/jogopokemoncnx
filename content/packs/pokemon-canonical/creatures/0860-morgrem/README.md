...
Dados canônicos e inventários auditáveis de `morgrem`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0860-morgrem--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
