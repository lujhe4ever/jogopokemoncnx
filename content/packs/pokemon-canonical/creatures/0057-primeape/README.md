...
Dados canônicos e inventários auditáveis de `primeape`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0057-primeape--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
