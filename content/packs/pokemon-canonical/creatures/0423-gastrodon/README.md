...
Dados canônicos e inventários auditáveis de `gastrodon`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0423-gastrodon--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
