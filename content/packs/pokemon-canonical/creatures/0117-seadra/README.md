...
Dados canônicos e inventários auditáveis de `seadra`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0117-seadra--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
