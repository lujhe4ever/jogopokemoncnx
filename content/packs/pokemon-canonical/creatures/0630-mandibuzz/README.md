...
Dados canônicos e inventários auditáveis de `mandibuzz`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0630-mandibuzz--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
