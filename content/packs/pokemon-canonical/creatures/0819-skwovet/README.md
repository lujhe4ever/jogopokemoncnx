...
Dados canônicos e inventários auditáveis de `skwovet`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0819-skwovet--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
