...
Dados canônicos e inventários auditáveis de `nidorina`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0030-nidorina--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
