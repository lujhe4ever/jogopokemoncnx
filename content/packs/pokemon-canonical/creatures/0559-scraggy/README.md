...
Dados canônicos e inventários auditáveis de `scraggy`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0559-scraggy--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
