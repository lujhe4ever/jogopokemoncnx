...
Dados canônicos e inventários auditáveis de `turtonator`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0776-turtonator--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
