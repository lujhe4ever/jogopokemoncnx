...
Dados canônicos e inventários auditáveis de `primarina`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0730-primarina--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
