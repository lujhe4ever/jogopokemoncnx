...
Dados canônicos e inventários auditáveis de `quilladin`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0651-quilladin--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
