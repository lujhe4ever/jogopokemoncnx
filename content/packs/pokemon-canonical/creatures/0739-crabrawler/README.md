...
Dados canônicos e inventários auditáveis de `crabrawler`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0739-crabrawler--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
