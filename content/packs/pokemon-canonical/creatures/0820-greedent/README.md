...
Dados canônicos e inventários auditáveis de `greedent`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0820-greedent--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
