...
Dados canônicos e inventários auditáveis de `hoothoot`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0163-hoothoot--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
