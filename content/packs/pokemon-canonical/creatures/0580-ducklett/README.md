...
Dados canônicos e inventários auditáveis de `ducklett`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0580-ducklett--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
