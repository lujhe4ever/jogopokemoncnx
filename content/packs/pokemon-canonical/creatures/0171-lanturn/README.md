...
Dados canônicos e inventários auditáveis de `lanturn`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0171-lanturn--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
