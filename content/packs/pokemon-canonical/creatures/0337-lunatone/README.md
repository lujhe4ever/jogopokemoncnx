...
Dados canônicos e inventários auditáveis de `lunatone`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0337-lunatone--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
