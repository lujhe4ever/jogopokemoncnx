...
Dados canônicos e inventários auditáveis de `meowstic`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0678-meowstic--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
