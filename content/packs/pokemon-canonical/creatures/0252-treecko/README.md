...
Dados canônicos e inventários auditáveis de `treecko`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0252-treecko--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
