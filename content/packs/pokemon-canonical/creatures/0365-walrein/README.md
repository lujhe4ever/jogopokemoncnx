...
Dados canônicos e inventários auditáveis de `walrein`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0365-walrein--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
