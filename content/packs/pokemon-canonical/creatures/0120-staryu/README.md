...
Dados canônicos e inventários auditáveis de `staryu`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0120-staryu--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
