...
Dados canônicos e inventários auditáveis de `charjabug`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0737-charjabug--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
