...
Dados canônicos e inventários auditáveis de `leavanny`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0542-leavanny--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
