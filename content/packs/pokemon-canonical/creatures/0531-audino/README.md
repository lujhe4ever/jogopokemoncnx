...
Dados canônicos e inventários auditáveis de `audino`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0531-audino--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
