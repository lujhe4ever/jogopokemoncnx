...
Dados canônicos e inventários auditáveis de `shelgon`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0372-shelgon--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
