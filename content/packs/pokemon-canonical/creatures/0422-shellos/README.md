...
Dados canônicos e inventários auditáveis de `shellos`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0422-shellos--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
