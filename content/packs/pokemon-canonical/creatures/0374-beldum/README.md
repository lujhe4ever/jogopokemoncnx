...
Dados canônicos e inventários auditáveis de `beldum`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0374-beldum--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
