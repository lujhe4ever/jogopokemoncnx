...
Dados canônicos e inventários auditáveis de `ponyta`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0077-ponyta--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
