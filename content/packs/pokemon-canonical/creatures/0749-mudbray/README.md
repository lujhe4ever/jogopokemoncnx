...
Dados canônicos e inventários auditáveis de `mudbray`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0749-mudbray--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
