...
Dados canônicos e inventários auditáveis de `skorupi`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0451-skorupi--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
