...
Dados canônicos e inventários auditáveis de `hydrapple`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `1019-hydrapple--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
