...
Dados canônicos e inventários auditáveis de `throh`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0538-throh--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
