...
Dados canônicos e inventários auditáveis de `venonat`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0048-venonat--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
