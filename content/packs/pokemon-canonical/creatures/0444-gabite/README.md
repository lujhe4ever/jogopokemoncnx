...
Dados canônicos e inventários auditáveis de `gabite`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0444-gabite--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
