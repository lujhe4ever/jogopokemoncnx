...
Dados canônicos e inventários auditáveis de `palkia`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0484-palkia--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
