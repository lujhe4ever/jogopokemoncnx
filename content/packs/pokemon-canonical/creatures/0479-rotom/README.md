...
Dados canônicos e inventários auditáveis de `rotom`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0479-rotom--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
