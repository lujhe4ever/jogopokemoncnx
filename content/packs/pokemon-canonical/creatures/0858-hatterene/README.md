...
Dados canônicos e inventários auditáveis de `hatterene`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0858-hatterene--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
