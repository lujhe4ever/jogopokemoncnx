...
Dados canônicos e inventários auditáveis de `timburr`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0532-timburr--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
