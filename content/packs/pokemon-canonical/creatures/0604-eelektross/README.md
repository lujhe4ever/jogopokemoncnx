...
Dados canônicos e inventários auditáveis de `eelektross`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0604-eelektross--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
