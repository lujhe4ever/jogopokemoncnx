...
Dados canônicos e inventários auditáveis de `slowpoke`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0079-slowpoke--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
