...
Dados canônicos e inventários auditáveis de `seel`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0086-seel--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
