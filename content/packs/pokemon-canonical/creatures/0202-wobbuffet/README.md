...
Dados canônicos e inventários auditáveis de `wobbuffet`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0202-wobbuffet--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
