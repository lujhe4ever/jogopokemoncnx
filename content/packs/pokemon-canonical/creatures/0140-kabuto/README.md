...
Dados canônicos e inventários auditáveis de `kabuto`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0140-kabuto--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
