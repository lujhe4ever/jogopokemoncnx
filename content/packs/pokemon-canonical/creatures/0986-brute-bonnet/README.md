...
Dados canônicos e inventários auditáveis de `brute-bonnet`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0986-brute-bonnet--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
