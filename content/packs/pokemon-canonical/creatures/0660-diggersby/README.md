...
Dados canônicos e inventários auditáveis de `diggersby`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0660-diggersby--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
