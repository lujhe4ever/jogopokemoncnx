...
Dados canônicos e inventários auditáveis de `virizion`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0640-virizion--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
