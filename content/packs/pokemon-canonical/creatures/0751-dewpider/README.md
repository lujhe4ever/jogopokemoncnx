...
Dados canônicos e inventários auditáveis de `dewpider`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0751-dewpider--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
