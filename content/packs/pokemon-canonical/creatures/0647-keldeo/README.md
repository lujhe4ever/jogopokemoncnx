...
Dados canônicos e inventários auditáveis de `keldeo`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0647-keldeo--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
