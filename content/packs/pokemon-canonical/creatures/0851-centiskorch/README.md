...
Dados canônicos e inventários auditáveis de `centiskorch`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0851-centiskorch--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
