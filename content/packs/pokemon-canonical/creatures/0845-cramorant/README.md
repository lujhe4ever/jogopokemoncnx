...
Dados canônicos e inventários auditáveis de `cramorant`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0845-cramorant--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
