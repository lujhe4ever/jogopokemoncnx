...
Dados canônicos e inventários auditáveis de `togedemaru`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0777-togedemaru--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
