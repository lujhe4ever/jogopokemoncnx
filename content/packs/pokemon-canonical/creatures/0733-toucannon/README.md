...
Dados canônicos e inventários auditáveis de `toucannon`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0733-toucannon--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
