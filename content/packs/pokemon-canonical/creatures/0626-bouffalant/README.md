...
Dados canônicos e inventários auditáveis de `bouffalant`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0626-bouffalant--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
