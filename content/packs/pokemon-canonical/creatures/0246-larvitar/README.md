...
Dados canônicos e inventários auditáveis de `larvitar`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0246-larvitar--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
