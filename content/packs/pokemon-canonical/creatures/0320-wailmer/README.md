...
Dados canônicos e inventários auditáveis de `wailmer`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0320-wailmer--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
