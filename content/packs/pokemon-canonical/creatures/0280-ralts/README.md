...
Dados canônicos e inventários auditáveis de `ralts`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0280-ralts--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
