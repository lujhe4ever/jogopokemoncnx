...
Dados canônicos e inventários auditáveis de `sableye`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0302-sableye--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
