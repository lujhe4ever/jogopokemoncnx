...
Dados canônicos e inventários auditáveis de `smoliv`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0928-smoliv--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
