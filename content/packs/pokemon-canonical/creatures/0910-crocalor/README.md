...
Dados canônicos e inventários auditáveis de `crocalor`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0910-crocalor--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
