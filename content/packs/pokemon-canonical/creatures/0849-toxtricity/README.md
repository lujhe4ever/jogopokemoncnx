...
Dados canônicos e inventários auditáveis de `toxtricity`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0849-toxtricity--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
