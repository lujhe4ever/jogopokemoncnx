...
Dados canônicos e inventários auditáveis de `machamp`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0068-machamp--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
