...
Dados canônicos e inventários auditáveis de `octillery`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0224-octillery--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
