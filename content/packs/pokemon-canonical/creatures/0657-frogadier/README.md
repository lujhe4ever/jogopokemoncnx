...
Dados canônicos e inventários auditáveis de `frogadier`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0657-frogadier--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
