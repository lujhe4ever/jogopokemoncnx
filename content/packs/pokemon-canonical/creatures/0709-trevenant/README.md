...
Dados canônicos e inventários auditáveis de `trevenant`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0709-trevenant--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
