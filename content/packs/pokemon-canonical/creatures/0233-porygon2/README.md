...
Dados canônicos e inventários auditáveis de `porygon2`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0233-porygon2--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
