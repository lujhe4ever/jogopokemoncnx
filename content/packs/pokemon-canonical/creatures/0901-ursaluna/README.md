...
Dados canônicos e inventários auditáveis de `ursaluna`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0901-ursaluna--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
