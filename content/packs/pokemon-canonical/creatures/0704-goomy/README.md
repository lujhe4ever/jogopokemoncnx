...
Dados canônicos e inventários auditáveis de `goomy`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0704-goomy--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
