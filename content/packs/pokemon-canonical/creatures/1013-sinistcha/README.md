...
Dados canônicos e inventários auditáveis de `sinistcha`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `1013-sinistcha--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
