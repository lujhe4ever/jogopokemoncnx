...
Dados canônicos e inventários auditáveis de `corsola`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0222-corsola--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
