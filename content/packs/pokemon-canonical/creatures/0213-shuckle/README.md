...
Dados canônicos e inventários auditáveis de `shuckle`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0213-shuckle--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
