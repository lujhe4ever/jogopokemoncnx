...
Dados canônicos e inventários auditáveis de `zoroark`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0571-zoroark--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
