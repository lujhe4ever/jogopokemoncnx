...
Dados canônicos e inventários auditáveis de `cyclizar`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0967-cyclizar--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
