...
Dados canônicos e inventários auditáveis de `incineroar`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0727-incineroar--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
