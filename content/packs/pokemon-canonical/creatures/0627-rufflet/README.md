...
Dados canônicos e inventários auditáveis de `rufflet`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0627-rufflet--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
