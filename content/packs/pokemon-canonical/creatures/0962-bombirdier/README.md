...
Dados canônicos e inventários auditáveis de `bombirdier`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0962-bombirdier--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
