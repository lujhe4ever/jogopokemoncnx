...
Dados canônicos e inventários auditáveis de `duskull`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0355-duskull--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
