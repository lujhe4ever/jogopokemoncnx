...
Dados canônicos e inventários auditáveis de `tympole`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0535-tympole--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
