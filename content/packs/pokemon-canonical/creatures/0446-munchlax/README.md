...
Dados canônicos e inventários auditáveis de `munchlax`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0446-munchlax--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
