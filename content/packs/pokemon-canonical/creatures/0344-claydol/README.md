...
Dados canônicos e inventários auditáveis de `claydol`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0344-claydol--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
