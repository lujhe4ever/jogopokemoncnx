...
Dados canônicos e inventários auditáveis de `gardevoir`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0282-gardevoir--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
