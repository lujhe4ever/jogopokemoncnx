...
Dados canônicos e inventários auditáveis de `chimchar`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0390-chimchar--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
