...
Dados canônicos e inventários auditáveis de `floatzel`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0419-floatzel--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
