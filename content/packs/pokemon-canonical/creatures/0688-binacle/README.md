...
Dados canônicos e inventários auditáveis de `binacle`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0688-binacle--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
