...
Dados canônicos e inventários auditáveis de `chatot`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0441-chatot--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
