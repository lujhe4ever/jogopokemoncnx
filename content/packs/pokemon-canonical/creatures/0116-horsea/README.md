...
Dados canônicos e inventários auditáveis de `horsea`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0116-horsea--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
