...
Dados canônicos e inventários auditáveis de `joltik`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0595-joltik--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
