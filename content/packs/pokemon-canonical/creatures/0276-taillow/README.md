...
Dados canônicos e inventários auditáveis de `taillow`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0276-taillow--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
