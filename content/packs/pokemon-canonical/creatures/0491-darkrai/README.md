...
Dados canônicos e inventários auditáveis de `darkrai`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0491-darkrai--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
