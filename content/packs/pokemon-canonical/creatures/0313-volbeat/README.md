...
Dados canônicos e inventários auditáveis de `volbeat`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0313-volbeat--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
