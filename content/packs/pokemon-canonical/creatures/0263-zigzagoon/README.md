...
Dados canônicos e inventários auditáveis de `zigzagoon`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0263-zigzagoon--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
