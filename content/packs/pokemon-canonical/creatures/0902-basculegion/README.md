...
Dados canônicos e inventários auditáveis de `basculegion`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0902-basculegion--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
