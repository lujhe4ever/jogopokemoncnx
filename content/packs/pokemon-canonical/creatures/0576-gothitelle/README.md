...
Dados canônicos e inventários auditáveis de `gothitelle`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0576-gothitelle--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
