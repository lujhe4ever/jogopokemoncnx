...
Dados canônicos e inventários auditáveis de `skuntank`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0435-skuntank--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
