...
Dados canônicos e inventários auditáveis de `qwilfish`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0211-qwilfish--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
