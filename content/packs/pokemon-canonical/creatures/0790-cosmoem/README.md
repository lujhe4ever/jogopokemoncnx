...
Dados canônicos e inventários auditáveis de `cosmoem`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0790-cosmoem--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
