...
Dados canônicos e inventários auditáveis de `kakuna`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0014-kakuna--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
