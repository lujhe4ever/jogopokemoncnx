...
Dados canônicos e inventários auditáveis de `cinderace`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0815-cinderace--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
