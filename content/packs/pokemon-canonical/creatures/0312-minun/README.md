...
Dados canônicos e inventários auditáveis de `minun`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0312-minun--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
