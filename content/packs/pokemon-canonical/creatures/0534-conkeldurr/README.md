...
Dados canônicos e inventários auditáveis de `conkeldurr`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0534-conkeldurr--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
