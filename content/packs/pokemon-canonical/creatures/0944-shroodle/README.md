...
Dados canônicos e inventários auditáveis de `shroodle`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0944-shroodle--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
