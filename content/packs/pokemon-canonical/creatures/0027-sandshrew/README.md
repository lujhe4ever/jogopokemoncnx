...
Dados canônicos e inventários auditáveis de `sandshrew`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0027-sandshrew--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
