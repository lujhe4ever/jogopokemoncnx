...
Dados canônicos e inventários auditáveis de `whiscash`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0340-whiscash--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
