...
Dados canônicos e inventários auditáveis de `mr-mime`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0122-mr-mime--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
