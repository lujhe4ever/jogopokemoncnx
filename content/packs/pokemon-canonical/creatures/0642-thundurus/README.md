...
Dados canônicos e inventários auditáveis de `thundurus`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0642-thundurus--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
