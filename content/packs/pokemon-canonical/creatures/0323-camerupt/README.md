...
Dados canônicos e inventários auditáveis de `camerupt`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0323-camerupt--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
