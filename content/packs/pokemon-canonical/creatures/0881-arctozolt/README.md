...
Dados canônicos e inventários auditáveis de `arctozolt`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0881-arctozolt--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
