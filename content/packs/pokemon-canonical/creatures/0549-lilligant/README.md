...
Dados canônicos e inventários auditáveis de `lilligant`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0549-lilligant--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
