...
Dados canônicos e inventários auditáveis de `charmander`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0004-charmander--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
