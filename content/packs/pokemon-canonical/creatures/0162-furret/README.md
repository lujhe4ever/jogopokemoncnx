...
Dados canônicos e inventários auditáveis de `furret`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0162-furret--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
