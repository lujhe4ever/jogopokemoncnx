...
Dados canônicos e inventários auditáveis de `wartortle`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0008-wartortle--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
