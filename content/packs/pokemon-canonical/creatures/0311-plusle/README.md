...
Dados canônicos e inventários auditáveis de `plusle`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0311-plusle--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
