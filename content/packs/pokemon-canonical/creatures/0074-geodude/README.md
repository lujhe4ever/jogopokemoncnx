...
Dados canônicos e inventários auditáveis de `geodude`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0074-geodude--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
