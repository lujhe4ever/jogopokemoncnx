...
Dados canônicos e inventários auditáveis de `raticate`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0020-raticate--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
