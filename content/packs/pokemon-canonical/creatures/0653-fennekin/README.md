...
Dados canônicos e inventários auditáveis de `fennekin`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0653-fennekin--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
