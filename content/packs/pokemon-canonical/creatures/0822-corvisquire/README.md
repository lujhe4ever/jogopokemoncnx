...
Dados canônicos e inventários auditáveis de `corvisquire`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0822-corvisquire--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
