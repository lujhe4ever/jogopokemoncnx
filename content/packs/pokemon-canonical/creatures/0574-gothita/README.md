...
Dados canônicos e inventários auditáveis de `gothita`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0574-gothita--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
