...
Dados canônicos e inventários auditáveis de `drifloon`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0425-drifloon--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
