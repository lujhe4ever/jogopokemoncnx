...
Dados canônicos e inventários auditáveis de `persian`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0053-persian--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
