...
Dados canônicos e inventários auditáveis de `koffing`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0109-koffing--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
