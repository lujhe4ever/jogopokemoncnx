...
Dados canônicos e inventários auditáveis de `ursaring`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0217-ursaring--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
