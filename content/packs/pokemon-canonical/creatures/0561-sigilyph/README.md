...
Dados canônicos e inventários auditáveis de `sigilyph`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0561-sigilyph--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
