...
Dados canônicos e inventários auditáveis de `swirlix`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0684-swirlix--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
