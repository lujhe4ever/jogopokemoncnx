...
Dados canônicos e inventários auditáveis de `prinplup`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0394-prinplup--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
