...
Dados canônicos e inventários auditáveis de `xerneas`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0716-xerneas--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
