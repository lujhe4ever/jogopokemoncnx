...
Dados canônicos e inventários auditáveis de `thwackey`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0811-thwackey--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
