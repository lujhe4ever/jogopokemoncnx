...
Dados canônicos e inventários auditáveis de `heatmor`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0631-heatmor--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
