...
Dados canônicos e inventários auditáveis de `swampert`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0260-swampert--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
