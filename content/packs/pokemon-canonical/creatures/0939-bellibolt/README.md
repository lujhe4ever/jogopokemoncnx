...
Dados canônicos e inventários auditáveis de `bellibolt`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0939-bellibolt--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
