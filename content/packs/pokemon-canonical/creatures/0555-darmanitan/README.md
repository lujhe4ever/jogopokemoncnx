...
Dados canônicos e inventários auditáveis de `darmanitan`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0555-darmanitan--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
