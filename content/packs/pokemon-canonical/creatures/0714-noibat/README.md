...
Dados canônicos e inventários auditáveis de `noibat`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0714-noibat--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
