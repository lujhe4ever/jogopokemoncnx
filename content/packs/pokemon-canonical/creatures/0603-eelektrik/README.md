...
Dados canônicos e inventários auditáveis de `eelektrik`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0603-eelektrik--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
