...
Dados canônicos e inventários auditáveis de `cofagrigus`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0563-cofagrigus--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
