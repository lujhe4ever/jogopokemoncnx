...
Dados canônicos e inventários auditáveis de `clefairy`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0035-clefairy--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
