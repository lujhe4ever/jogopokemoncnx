...
Dados canônicos e inventários auditáveis de `zamazenta`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0889-zamazenta--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
