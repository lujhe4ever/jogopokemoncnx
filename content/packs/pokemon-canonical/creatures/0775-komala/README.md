...
Dados canônicos e inventários auditáveis de `komala`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0775-komala--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
