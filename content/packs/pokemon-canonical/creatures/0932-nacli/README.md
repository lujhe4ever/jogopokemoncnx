...
Dados canônicos e inventários auditáveis de `nacli`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0932-nacli--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
