...
Dados canônicos e inventários auditáveis de `honedge`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0679-honedge--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
