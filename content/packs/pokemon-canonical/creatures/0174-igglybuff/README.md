...
Dados canônicos e inventários auditáveis de `igglybuff`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0174-igglybuff--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
