...
Dados canônicos e inventários auditáveis de `tadbulb`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0938-tadbulb--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
