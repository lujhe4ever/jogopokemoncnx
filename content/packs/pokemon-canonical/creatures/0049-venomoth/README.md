...
Dados canônicos e inventários auditáveis de `venomoth`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0049-venomoth--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
