...
Dados canônicos e inventários auditáveis de `spinarak`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0167-spinarak--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
