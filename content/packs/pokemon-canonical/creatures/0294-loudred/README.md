...
Dados canônicos e inventários auditáveis de `loudred`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0294-loudred--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
