...
Dados canônicos e inventários auditáveis de `raikou`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0243-raikou--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
