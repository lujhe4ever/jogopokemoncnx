...
Dados canônicos e inventários auditáveis de `kingambit`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0983-kingambit--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
