...
Dados canônicos e inventários auditáveis de `absol`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0359-absol--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
