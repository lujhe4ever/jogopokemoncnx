...
Dados canônicos e inventários auditáveis de `cosmog`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0789-cosmog--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
