...
Dados canônicos e inventários auditáveis de `dusclops`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0356-dusclops--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
