...
Dados canônicos e inventários auditáveis de `exeggutor`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0103-exeggutor--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
