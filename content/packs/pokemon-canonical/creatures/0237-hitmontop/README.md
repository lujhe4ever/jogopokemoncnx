...
Dados canônicos e inventários auditáveis de `hitmontop`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0237-hitmontop--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
