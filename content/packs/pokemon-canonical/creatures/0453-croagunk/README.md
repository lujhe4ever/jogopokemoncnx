...
Dados canônicos e inventários auditáveis de `croagunk`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0453-croagunk--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
