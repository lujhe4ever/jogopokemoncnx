...
Dados canônicos e inventários auditáveis de `accelgor`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0617-accelgor--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
