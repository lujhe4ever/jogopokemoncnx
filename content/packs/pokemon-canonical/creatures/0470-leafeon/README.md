...
Dados canônicos e inventários auditáveis de `leafeon`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0470-leafeon--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
