...
Dados canônicos e inventários auditáveis de `trumbeak`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0732-trumbeak--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
