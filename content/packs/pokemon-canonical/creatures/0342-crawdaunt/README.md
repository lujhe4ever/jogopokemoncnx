...
Dados canônicos e inventários auditáveis de `crawdaunt`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0342-crawdaunt--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
