...
Dados canônicos e inventários auditáveis de `cranidos`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0408-cranidos--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
