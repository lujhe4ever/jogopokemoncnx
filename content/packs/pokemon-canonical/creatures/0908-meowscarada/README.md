...
Dados canônicos e inventários auditáveis de `meowscarada`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0908-meowscarada--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
