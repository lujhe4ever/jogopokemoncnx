...
Dados canônicos e inventários auditáveis de `lampent`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0608-lampent--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
