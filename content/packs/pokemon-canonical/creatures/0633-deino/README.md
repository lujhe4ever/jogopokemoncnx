...
Dados canônicos e inventários auditáveis de `deino`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0633-deino--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
