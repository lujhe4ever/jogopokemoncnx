...
Dados canônicos e inventários auditáveis de `slowbro`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0080-slowbro--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
