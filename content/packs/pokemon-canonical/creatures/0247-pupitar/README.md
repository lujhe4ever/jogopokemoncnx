...
Dados canônicos e inventários auditáveis de `pupitar`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0247-pupitar--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
