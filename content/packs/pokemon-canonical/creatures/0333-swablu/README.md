...
Dados canônicos e inventários auditáveis de `swablu`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0333-swablu--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
