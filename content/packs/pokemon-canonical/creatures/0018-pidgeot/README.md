...
Dados canônicos e inventários auditáveis de `pidgeot`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0018-pidgeot--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
