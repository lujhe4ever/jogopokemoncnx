...
Dados canônicos e inventários auditáveis de `glimmet`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0969-glimmet--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
