...
Dados canônicos e inventários auditáveis de `hoopa`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0720-hoopa--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
