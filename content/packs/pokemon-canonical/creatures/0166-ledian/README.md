...
Dados canônicos e inventários auditáveis de `ledian`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0166-ledian--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
