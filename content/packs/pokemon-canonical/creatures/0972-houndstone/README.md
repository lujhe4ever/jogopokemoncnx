...
Dados canônicos e inventários auditáveis de `houndstone`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0972-houndstone--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
