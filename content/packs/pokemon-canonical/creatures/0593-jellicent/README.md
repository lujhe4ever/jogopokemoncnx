...
Dados canônicos e inventários auditáveis de `jellicent`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0593-jellicent--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
