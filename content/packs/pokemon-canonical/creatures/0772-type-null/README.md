...
Dados canônicos e inventários auditáveis de `type-null`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0772-type-null--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
