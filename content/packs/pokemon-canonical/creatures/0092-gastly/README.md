...
Dados canônicos e inventários auditáveis de `gastly`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0092-gastly--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
