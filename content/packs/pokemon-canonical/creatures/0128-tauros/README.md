...
Dados canônicos e inventários auditáveis de `tauros`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0128-tauros--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
