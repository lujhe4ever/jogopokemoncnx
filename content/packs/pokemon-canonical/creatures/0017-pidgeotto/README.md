...
Dados canônicos e inventários auditáveis de `pidgeotto`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0017-pidgeotto--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
