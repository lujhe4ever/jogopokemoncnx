...
Dados canônicos e inventários auditáveis de `machop`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0066-machop--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
