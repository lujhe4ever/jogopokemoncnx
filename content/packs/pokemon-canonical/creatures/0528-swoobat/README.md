...
Dados canônicos e inventários auditáveis de `swoobat`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0528-swoobat--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
