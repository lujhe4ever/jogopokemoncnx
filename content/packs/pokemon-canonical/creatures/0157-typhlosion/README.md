...
Dados canônicos e inventários auditáveis de `typhlosion`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0157-typhlosion--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
