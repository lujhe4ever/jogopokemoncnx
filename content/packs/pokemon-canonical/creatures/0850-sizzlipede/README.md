...
Dados canônicos e inventários auditáveis de `sizzlipede`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0850-sizzlipede--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
