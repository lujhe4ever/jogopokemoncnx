...
Dados canônicos e inventários auditáveis de `delcatty`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0301-delcatty--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
