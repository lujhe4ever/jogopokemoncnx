...
Dados canônicos e inventários auditáveis de `chingling`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0433-chingling--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
