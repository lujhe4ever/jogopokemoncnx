...
Dados canônicos e inventários auditáveis de `graveler`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0075-graveler--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
