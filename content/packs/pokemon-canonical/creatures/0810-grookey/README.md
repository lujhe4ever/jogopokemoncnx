...
Dados canônicos e inventários auditáveis de `grookey`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0810-grookey--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
