...
Dados canônicos e inventários auditáveis de `jumpluff`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0189-jumpluff--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
