...
Dados canônicos e inventários auditáveis de `marowak`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0105-marowak--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
