...
Dados canônicos e inventários auditáveis de `clamperl`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0366-clamperl--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
