...
Dados canônicos e inventários auditáveis de `hoppip`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0187-hoppip--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
