...
Dados canônicos e inventários auditáveis de `totodile`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0158-totodile--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
