...
Dados canônicos e inventários auditáveis de `cursola`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0864-cursola--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
