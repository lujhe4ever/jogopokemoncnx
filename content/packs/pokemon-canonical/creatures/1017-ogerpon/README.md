...
Dados canônicos e inventários auditáveis de `ogerpon`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `1017-ogerpon--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
