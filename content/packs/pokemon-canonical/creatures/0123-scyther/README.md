...
Dados canônicos e inventários auditáveis de `scyther`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0123-scyther--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
