...
Dados canônicos e inventários auditáveis de `foongus`.

- `definitions/`: espécie, habilidades e learnset por jogo/geração.
- `sprites/`: inventário e sprite frontal `0590-foongus--pokeapi-default--front--normal.png` versionado por decisão do proprietário.
