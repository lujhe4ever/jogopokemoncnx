...
| Importar lote CC0 a partir do cache privado | `pnpm assets:import` |
| Gerar inventário e relatórios de assets | `pnpm assets:inventory` |
| Validar todos os catálogos e arquivos | `pnpm assets:validate` |
| Auditoria integral dos sprites Pokémon | `pnpm content:pokemon:audit` |
| Gerar catálogos centrais de assets | `pnpm content:assets:generate` |
| Auditar catálogo de sprites | `pnpm content:assets:audit` |
| Auditar catálogo de áudio | `pnpm content:audio:audit` |
| Auditar catálogo de animações | `pnpm content:animations:audit` |
